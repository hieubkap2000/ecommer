                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <button type="button" data-toggle="modal" onclick="insert()" data-target="#exampleModalCenter"
                                        class="btn btn-block btn-primary btn-flat">Thêm mới</button>
                                </div>
                            </div>
                        </div>
                        <!-- /.card-header -->
                                        ...
                                        <table id="example1" class="table table-bordered table-striped dataTable dtr-inline"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="text-center"> Thứ tự sắp xếp </th>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th rowspan="1" colspan="1">Tên Danh mục sản phẩm</th>
                                                    <th rowspan="1" colspan="1" class="text-center">Thứ tự sắp xếp</th>
                ...
                <form id="form">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control rounded-0" onkeyup="ChangeToSlug('category-name');" id="category-name"
...
@endsection
@section('script')
    <script src="{{ mix('js/admin/ProductCategory.js') }}"></script>
@endsection
