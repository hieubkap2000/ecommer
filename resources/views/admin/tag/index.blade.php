                ...
                <form id="form">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="exampleInputRounded0">Tên Tag <code>*</code></label>
                            <input type="text" class="form-control rounded-0" onkeyup="ChangeToSlug('tag_name');" id="tag_name"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="save()">Lưu Tag</button>
                    </div>
                </form>
            </div>
        </div>
